...
class QuizViewModel : ViewModel() {
    ...
    // TODO
    private val questionList = repository.questions
    ...
    // TODO
    private val _currentQuestion = MutableLiveData<Question>(questionList.value!![questionIndex])
    ...
    private fun resetGame() {
       ...
       questionIndex = 0
        _currentQuestion.value = questionList.value!![questionIndex]
    ...
    fun checkAnswer(answerIndex: Int) {
        // TODO Schreibe hier deinen Code
            if (answerIndex == currentQuestion.value?.rightAnswer) {
                if (_currentQuestion.value == questionList.value!![questionList.value!!.size-1]) {
